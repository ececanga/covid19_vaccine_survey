...
const CALENDAR_CANCEL =
    '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.FrameLayout
    /android.widget.LinearLayout/android.widget.ScrollView/android.widget.LinearLayout/android.widget.Button[1]';
const CALENDAR_TEXT =
    '//android.view.ViewGroup[@content-desc="birthday"]/android.widget.TextView';
const CITY_PICKER = '//android.widget.Spinner[@content-desc="city"]';
const CITY_ANKARA =
    '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/android.widget.CheckedTextView[7]';
...
const VACCINE_OTHER =
    '/hierarchy/android.widget.FrameLayout/android.widget.FrameLayout/android.widget.ListView/an droid.widget.CheckedTextView[10]';
...
describe('Testing invalid input formats', () => {
    beforeEach(() => {
        $("/hierarchy/android.widget.FrameLayout/android.widget.LinearLayout").waitForDisplayed(1100
        0, false)
    });
